...
//
// Description:
// this module wraps and connect all sub-modules of memory system
///////////////////////////////////////////////////////////////////////////////////////
...
module mem_sys (
  ...
  wire [NUM_READ_BUFFERS - 1 : 0] rd_buff_pre_full;
  wire [NUM_WRITE_BUFFERS - 1 : 0] wr_buff_pre_empty;
...
// Buffers filler instantiation
  buffers_filler buffers_filler_i (
    ...
    .rd_buff_pre_full(rd_buff_pre_full),
...
// Buffers discharger instantiation
  buffers_discharger buffers_discharger_i (
    ...
    .wr_buff_pre_empty(wr_buff_pre_empty),
