...
assign sram_data_oeb = (main_mem_rden || main_mem_rd_data_valid) ? {MAIN_MEM_DATA_WIDTH{1'b1}} : {MAIN_MEM_DATA_WIDTH{1'b0}}; // if 0 sram_data is output, if 1 sram data is input, if reading, we need sram_data to be an input, otherwise an output
