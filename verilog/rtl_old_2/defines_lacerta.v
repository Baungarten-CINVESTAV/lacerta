...
/*
parameter int READ_BUFFERS_DATA_WIDTHS [NUM_READ_BUFFERS] = '{default:MAIN_MEM_DATA_WIDTH};
parameter int READ_BUFFERS_NUM_ELEMENTS [NUM_READ_BUFFERS] = '{default:NUM_ELEMENTS_READ_BUFFERS};
parameter int WRITE_BUFFERS_DATA_WIDTHS [NUM_WRITE_BUFFERS] = '{default:MAIN_MEM_DATA_WIDTH};
parameter int WRITE_BUFFERS_NUM_ELEMENTS [NUM_WRITE_BUFFERS] = '{default:NUM_ELEMENTS_WRITE_BUFFERS};
*/
