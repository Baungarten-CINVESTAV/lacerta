...
parameter BOOLEAN_TYPE = 0;
parameter HORIZONTAL_INCREMENTAL_TYPE = 1;
parameter VERTICAL_INCREMENTAL_TYPE = 2;
parameter GRAPH_TYPE = 3;
parameter MASK_TYPE = 4; // like 7 segment displays
parameter MAXIMUM_INCREMENTAL_WIDTH = 500;
parameter MAXIMUM_INCREMENTAL_HEIGHT = 500;
parameter MAXIMUM_INCREMENTAL_WIDTH_BITS = $clog2(MAXIMUM_INCREMENTAL_WIDTH);
parameter MAXIMUM_INCREMENTAL_HEIGHT_BITS = $clog2(MAXIMUM_INCREMENTAL_HEIGHT);
